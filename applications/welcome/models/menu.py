...
if not (request.controller == 'meteoritepage'):
    session.met_index = 0
    session.met_sort = 'ID'
...
response.menu = [
    (T('Meteorite'), False, URL('meteoritepage', 'meteorite'), []),
    (T('UFO'), False, URL('ufopage', 'ufo'), []),
    (T('Map'), False, URL('mappage', 'map'), []),
    (T('Update'), False, URL('updatepage', 'update'), [])
]
